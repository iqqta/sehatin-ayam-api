    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
            <div class="p-6 text-gray-900">
                <form method="POST" action="{{ route('treatments.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea id="treat" name="treat" rows="5" class="mt-1 block w-full border-gray-300 focus:border-gray-400 focus:ring-gray-400 rounded-md shadow-sm" required>{{ old('treat') }}</textarea>
