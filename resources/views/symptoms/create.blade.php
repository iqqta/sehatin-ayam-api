        ...
        <div class="p-6 text-gray-900">
            ...
            <form action="{{ route('symptoms.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="symptom_code" type="text" name="symptom_code" placeholder="Contoh: G01">
                    @error('symptom_code')
